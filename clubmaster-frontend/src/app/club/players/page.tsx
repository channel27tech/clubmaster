...
export default function ClubPlayersPage() {
  ...
  return (
    <div className="min-h-screen bg-[#333939] flex flex-col w-full max-w-[400px] mx-auto relative">
      ...
      <div className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[400px] z-10 bg-[#333939]">
        {/* Header */}
      ...
      {/* Scrollable content area - only the player list is scrollable */}
      <div className="pt-[340px] pb-[120px]">
        {/* Player List */}
        {activeTab === 'players' && (
          <div
            className="overflow-y-auto mx-4 scrollbar-none mb-4"
            style={{
              scrollbarWidth: 'none',
          ...
          >
            ...
            `}</style>
            {players.map((player) => (
              <div key={player.rank} className="flex items-center py-2 border-b border-[#505454] bg-transparent">
                {/* Rank column */}
      ...
      {/* Join Button - Fixed position above footer */}
      <div className="fixed bottom-16 left-1/2 -translate-x-1/2 w-full max-w-[400px] px-4 py-3 bg-[#333939] border-t border-[#505454]">
        <button 
